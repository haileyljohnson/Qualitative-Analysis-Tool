...
- **Load a video** You can resize video using the slider on the left of the screen. And you can drag and drop the video anywhere you want on the screen as you work. Then use the keyboard for video control: 
...
- **The transcript is a spreadsheet** click any cell to edit, add rows/columns as needed, rename columns from the header. You can resize the transcript width and height by clicking the button "Resize Transcript" at top of page. You can resize the columns similar to excel. And you can delete columns under button "Columns" at top of page (did not want accidental mistakes). Hotkeys:
...
- Hotkeys for video play are rebindable in the settings (gear icon). 
